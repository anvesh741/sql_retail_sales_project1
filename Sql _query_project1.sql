...
-- How manu unique categories we have?
...
-- 'Clothing' and quantity sold is more than 4 in the month of Nov-2022
SELECT 
	 *
FROM retail_sales
...
-- 3. Write an SQL query to calculate the total_sales (total_sale) for each category.
...
-- 9. Write an SQL query is find the number of unique customers who purchased items from each category.
